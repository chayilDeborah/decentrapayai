    ...
    return (
        <main className='flex justify-center lg:mt-[185px] w-full '>
            <section className='text-center text-white w-[90%] '>
                <h1 className='lg:text-[40px] lg:leading-[48.4px] '>Our<span className='leverage'> Roadmap</span></h1>
                <p className='font-medium lg:text-[18px] lg:leading-[21.78px] tracking-[0.2px] lg:mt-[20px] lg:mb-[50px] lg:w-[78%] mx-auto '>Lorem ipsum dolor sit amet consectetur. Massa tincidunt malesuada ipsum imperdiet pulvinar nunc enim nulla. Velit tincidunt tellus tincidunt malesuada nibh porttitor.</p>
                    ...
                    <div className='border border-[1px] rounded-[10px] pl-[27px]  w-[336px] '>
                        ...
                        <div className='text-[15px] leading-[30px] w-[80%] tracking-[0.2px] text-left mt-[30px] mb-[44px] ml-[20px] '>
                            <ul className="list-disc">
                                ...
                                <li>Development: Launch of the Beta DApp Version.</li>
